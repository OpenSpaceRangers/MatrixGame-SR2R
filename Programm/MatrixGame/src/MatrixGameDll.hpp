...
struct SMGDRobotInterface {
    ...
    int (__stdcall * m_Run)(HINSTANCE hinst,HWND hwnd,wchar * map,SRobotsSettings * set,wchar * txt_start,wchar * txt_win,wchar * txt_loss,wchar * planet, SRobotGameState * rgs);
};
